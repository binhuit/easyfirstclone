...
class BaselineFeatureExtractor:  # {{{
    ...
    def extract(self, parsed, deps, i, sent=None):
        ...
        # supertag unigram
        append("f1w_st_%s_%s" % (f1_form,f1_stag))
        append("f2w_st_%s_%s" % (f2_form,f2_stag))
        append("n1w_st_%s_%s" % (n1_form,n1_stag))
        append("n2w_st_%s_%s" % (n2_form,n2_stag))
        append("p1w_st_%s_%s" % (p1_form,p1_stag))
        append("p2w_st_%s_%s" % (p2_form,p2_stag))
        append("f1t_st_%s_%s" % (f1_tag,f1_stag))
        append("f2t_st_%s_%s" % (f2_tag,f2_stag))
        append("n1t_st_%s_%s" % (n1_tag,n1_stag))
        append("n2t_st_%s_%s" % (n2_tag,n2_stag))
        append("p1t_st_%s_%s" % (p1_tag,p1_stag))
        append("p2t_st_%s_%s" % (p2_tag,p2_stag))
        # supertag bigram
        append("f1f2_ss_%s_%s" % (f1_stag, f2_stag))
        append("f1f2_ts_%s_%s" % (f1_tag, f2_stag))
        append("f1f2_st_%s_%s" % (f1_stag, f2_tag))
        append("f1f2_ws_%s_%s" % (f1_form, f2_stag))
        append("f1f2_sw_%s_%s" % (f1_stag, f2_form))

        append("f1n1_ss_%s_%s" % (f1_stag, n1_stag))
        append("f1n1_ts_%s_%s" % (f1_tag, n1_stag))
        append("f1n1_st_%s_%s" % (f1_stag, n1_tag))
        append("f1n1_ws_%s_%s" % (f1_form, n1_stag))
        append("f1n1_sw_%s_%s" % (f1_stag, n1_form))

        append("p1f1_ss_%s_%s" % (p1_stag, f1_stag))
        append("p1f1_ts_%s_%s" % (p1_tag, f1_stag))
        append("p1f1_st_%s_%s" % (p1_stag, f1_tag))
        append("p1f1_ws_%s_%s" % (p1_form, f1_stag))
        append("p1f1_sw_%s_%s" % (p1_stag, f1_form))

        append("p1n1_ss_%s_%s" % (p1_stag, n1_stag))
        append("p1n1_ts_%s_%s" % (p1_tag, n1_stag))
        append("p1n1_st_%s_%s" % (p1_stag, n1_tag))
        append("p1n1_ws_%s_%s" % (p1_form, n1_stag))
        append("p1n1_sw_%s_%s" % (p1_stag, n1_form))

        append("f2n1_ss_%s_%s" % (f2_stag, n1_stag))
        append("f2n1_ts_%s_%s" % (f2_tag, n1_stag))
        append("f2n1_st_%s_%s" % (f2_stag, n1_tag))
        append("f2n1_ws_%s_%s" % (f2_form, n1_stag))
        append("f2n1_sw_%s_%s" % (f2_stag, n1_form))
